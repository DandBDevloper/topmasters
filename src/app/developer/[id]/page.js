...
async function DeveloperV1 ({params}) {
    ...
    <>
      ...
      <section className="container">
        <div className="row d-flex justify-content-between">
          ...
          <div className="col-12 col-md-4 order-1 order-md-2 mb50 d-flex align-items-center justify-content-center" style={{ maxWidth: '300px' }}>
            <Image
              src="/images/developer/emaar-logo.webp"
              alt="A descriptive alt text"
              width={300}       // Numeric width for Next.js optimization
              height={150}      // Numeric height for Next.js optimization
              style={{
                width: '100%',  // Force the rendered width to be 100% of parent
      ...
      <div>
        <div className="container">
          ...
          <div className="col-lg-12">
            <h1 className="pb-5">Projects by Emaar Properties</h1>
