...
export default async function ProjectV1({ params }) {
  ...
  // Check the returned data structure (assuming it's like { data: [...] })
  ...
  return (
    <>
            ...
            <div className="listitems">
              <div className="DetailsList">
                ...
                <div className="DetailsItem">
                  <h3>AED {projectData.Full.start_price}</h3>
                  <p>Starting Price</p>
                </div>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 55 60" fill="none">
                ...
                <div className="DetailsItem">
                  <h3>{new Date(projectData.About.completion_date).getFullYear()}</h3>
                  <p>Handover</p>
                </div>
              </div>
              ...
              <div className="DetailsList">
                ...
                <div className="DetailsItem">
                <h3>{(Number(projectData.Payments[0].value) + Number(projectData.Payments[1].value))+ "/" + Number(projectData.Payments[2].value)}</h3>
                <p>Payment Plan</p>
                </div>
              </div>
            </div>
      ...
      <div className="container customPaddingProjectGallery">
        <div className="row">
          <PropertyGallery images={projectData.Full.images}/>
        </div>
      </div>
      ...
      <div className="bgc-f7 customPaddingProject">
        <div className="container">
        <div className=" overflow-hidden position-relative">
                <h4 className="title fz17 mb30">{projectData.Banner.project_name} Amenities</h4>
                <div className="row">
                  <OverView amenities={projectData.Full.amenities}/>
                </div>
              </div>
        </div>
      </div>
      ...
      <div className="">
          <div className="container customPaddingProjectGallery">
            <div className="row ">
              <div className="col-12 col-md-6 d-flex align-items-center" >
                <MapComponent lat={projectData.Location.lat} lng={projectData.Location.lng} markerTitle={projectData.Full.name}/>
              </div>

              <div className="col-12 col-md-6 color-white d-flex cntLocationSec flex-column justify-content-center align-items-center">
                {/* <h3>{projectData.Full.}</h3> */}
                <div dangerouslySetInnerHTML={{ __html: projectData.Full.address_description }} />

                <div className="row mt20">
                  {projectData.Full.project_nearby_areas && projectData.Full.project_nearby_areas.length > 0 ? (
                    projectData.Full.project_nearby_areas.map((area, index) => (
                      <div className="col-6 mb25" key={index}>
                        <div className="overview-element d-flex align-items-center">
                          <div className="ml15">
                            <h6 className="mb-0">{area.time_distance}</h6>
                            <p className="text mb-0 fz15">{area.to_location}</p>
                          </div>
                        </div>
                      </div>
                    ))
                  ) : (
                    <p>No nearby area information available.</p>
                  )}
                </div>
              </div>
      ...
      <div className="bgc-f7 customPaddingProject">
        <div className="container">
              <div className="floorplanHeading">
                <h3>{projectData.Banner.banner_bref} Payment Plan</h3>
              </div>
              <div className="row text-center gx-5">
                  <div className="col-12 col-md-4 mb-4 mb-sm-0 ">
                      <div className="paymentplanCard">
                        <h2>{projectData.Payments[0].value}%</h2>
                        <p>{projectData.Payments[0].title}</p>
                      </div>
                  </div>

                  <div className="col-12 col-md-4 mb-4 mb-sm-0">
                  <div className="paymentplanCard">
                        <h2>{projectData.Payments[1].value}%</h2>
                        <p>{projectData.Payments[1].title}</p>
                      </div>
                  </div>

                  <div className="col-12 col-md-4">
                  <div className="paymentplanCard">
                        <h2>{projectData.Payments[2].value}%</h2>
                        <p>{projectData.Payments[2].title}</p>
                      </div>
                  </div>
              </div>
        </div>
